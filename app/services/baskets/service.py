...
from app.services.baskets.factors import build_factor_model
...
class BasketService:
    """Owns factor model, basket optimization, and basket cache.

    Receives refs + hists at init (read-only snapshots).
    Builds factor model, runs batch optimization or
    ...
    def __init__(
        ...
        self.refs = refs
        self.hists = hists
        self.factor_model = build_factor_model(refs, hists)
